...
import com.example.tmdb.R
    ...
    @Composable
    fun SearchView(state: MutableState<TextFieldValue>, searching : MutableState<Boolean>, searchingCards : MutableState<Boolean>
    ){
        ...
        TextField(
            ...
            leadingIcon = {
                Icon(
                    ...
                    modifier = Modifier
                        .padding(15.dp)
                        .size(24.dp).clickable { searchingCards.value = true}
                )
            },
            /*trailingIcon = {
    ...
    @Composable
    fun CancelButton(state: MutableState<TextFieldValue>, searching: MutableState<Boolean>, searchingCards : MutableState<Boolean>){
...
fun SearchCard(painter : Painter, name : String, visible : MutableState<Boolean>){
    Card(
        ...
        Box(modifier = Modifier
            ...
            Text(text = "After being held captive in an Afghan cave," +
